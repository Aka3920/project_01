<template>
  <div class="case-num">
    <div class="container">
      <div class="title">
        <span>截至 {{ formatData(covidNum.modifyTime) }}全国数据统计</span>
      </div>
    </div>
    <div class="num">
      <ul class="count">
        <li>
          <div class="create-item">
            <div class="create-count">
              <b> <em>较昨日</em>{{ formateNum(covidNum.currentConfirmedIncr) }}</b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(247, 130, 7)">{{ formateNum(covidNum.confirmedIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(162, 90, 78)">{{ formateNum(covidNum.yesterdaySuspectedCountIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(174, 33, 44)">{{ formateNum(covidNum.curedIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(93, 112, 146)">{{ formateNum(covidNum.deadIncr) }}</em>
              </b>
            </div>
        ...
        <li>
          <div class="create-item">
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(40, 183, 163)">{{ formateNum(covidNum.seriousIncr) }}</em>
              </b>
            </div>
...
export default {
  ...
  methods: {
    ...
    echartsInit() {
      ...
      this.$echarts.init(document.getElementById('line')).setOption({
        xAxis: {
          type: 'category',
